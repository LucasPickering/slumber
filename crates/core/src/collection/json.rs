...
impl JsonTemplate {
    ...
    ///
    /// This will always return a single chunk, which is either a [Value] or
    /// an error. Streaming is not possible here.
    ///
    /// TODO ^ that should be asserted through the type system
